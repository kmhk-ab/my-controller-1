...
import (
	...
	samplecontrollerv1alpha1 "github.com/kmhk-ab/my-controller-1/api/v1alpha1"
	"github.com/kmhk-ab/my-controller-1/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "72ecade8.k8s.io",
